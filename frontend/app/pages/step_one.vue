<template>
  <v-app>
    <v-app-bar
      ...
      class="border-b"
    >
      <v-container class="d-flex align-center px-6 px-sm-10">
            ...
            >
              ...
              <v-form ref="form" v-model="valid">
                ...
                <v-textarea
                  ...
                  color="primary"
                  rows="4"
                  placeholder="e.g., Black leather wallet with a silver clasp"
                  class="mb-4"
                  :rules="[rules.required]"
                />
